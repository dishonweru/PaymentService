 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}GetImageImport" minOccurs="0"/>
...
@XmlRootElement(name = "SCN001V_GetImage")
public class SCN001VGetImage {

    @XmlElement(name = "import")
    protected GetImageImport _import;
     ...
     *     
     */
    public GetImageImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(GetImageImport value) {
        this._import = value;
    }
