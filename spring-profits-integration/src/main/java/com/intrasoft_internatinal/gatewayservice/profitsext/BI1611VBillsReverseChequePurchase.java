 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}BillsReverseChequePurchaseImport" minOccurs="0"/>
...
@XmlRootElement(name = "BI1611V_BillsReverseChequePurchase")
public class BI1611VBillsReverseChequePurchase {

    @XmlElement(name = "import")
    protected BillsReverseChequePurchaseImport _import;
     ...
     * @return
     *     possible object is
     *     {@link BillsReverseChequePurchaseImport }
     *     
     */
    public BillsReverseChequePurchaseImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(BillsReverseChequePurchaseImport value) {
        this._import = value;
    }
