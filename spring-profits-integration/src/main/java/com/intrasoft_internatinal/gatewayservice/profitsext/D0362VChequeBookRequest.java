 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}ChequeBookRequestImport" minOccurs="0"/>
...
@XmlRootElement(name = "D0362V_ChequeBookRequest")
public class D0362VChequeBookRequest {

    @XmlElement(name = "import")
    protected ChequeBookRequestImport _import;
     ...
     * @return
     *     possible object is
     *     {@link ChequeBookRequestImport }
     *     
     */
    public ChequeBookRequestImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(ChequeBookRequestImport value) {
        this._import = value;
    }
