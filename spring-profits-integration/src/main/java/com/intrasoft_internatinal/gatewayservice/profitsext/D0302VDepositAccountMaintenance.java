 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}DepositAccountRetrieveImport" minOccurs="0"/>
...
@XmlRootElement(name = "D0302V_DepositAccountMaintenance")
public class D0302VDepositAccountMaintenance {

    @XmlElement(name = "import")
    protected DepositAccountRetrieveImport _import;
     ...
     * @return
     *     possible object is
     *     {@link DepositAccountRetrieveImport }
     *     
     */
    public DepositAccountRetrieveImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(DepositAccountRetrieveImport value) {
        this._import = value;
    }
