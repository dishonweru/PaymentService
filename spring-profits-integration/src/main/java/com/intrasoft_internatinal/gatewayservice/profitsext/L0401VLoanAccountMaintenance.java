 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}LoanAccountMaintenanceImport" minOccurs="0"/>
...
@XmlRootElement(name = "L0401V_LoanAccountMaintenance")
public class L0401VLoanAccountMaintenance {

    @XmlElement(name = "import")
    protected LoanAccountMaintenanceImport _import;
     ...
     * @return
     *     possible object is
     *     {@link LoanAccountMaintenanceImport }
     *     
     */
    public LoanAccountMaintenanceImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(LoanAccountMaintenanceImport value) {
        this._import = value;
    }
