 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}T1461VLgGuarantorMaintenanceImport" minOccurs="0"/>
...
@XmlRootElement(name = "T1461V_LgGuarantorMaintenance")
public class T1461VLgGuarantorMaintenance {

    @XmlElement(name = "import")
    protected T1461VLgGuarantorMaintenanceImport _import;
     ...
     * @return
     *     possible object is
     *     {@link T1461VLgGuarantorMaintenanceImport }
     *     
     */
    public T1461VLgGuarantorMaintenanceImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(T1461VLgGuarantorMaintenanceImport value) {
        this._import = value;
    }
