 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}T1477_GetTheVoucherImport" minOccurs="0"/>
...
@XmlRootElement(name = "T1477V_GetTheVoucher")
public class T1477VGetTheVoucher {

    @XmlElement(name = "import")
    protected T1477GetTheVoucherImport _import;
     ...
     * @return
     *     possible object is
     *     {@link T1477GetTheVoucherImport }
     *     
     */
    public T1477GetTheVoucherImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(T1477GetTheVoucherImport value) {
        this._import = value;
    }
