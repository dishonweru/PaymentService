 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}CI3496V_GetUserInfoImport" minOccurs="0"/>
...
@XmlRootElement(name = "CI3496V_GetUserInfo")
public class CI3496VGetUserInfo {

    @XmlElement(name = "import")
    protected CI3496VGetUserInfoImport _import;
     ...
     * @return
     *     possible object is
     *     {@link CI3496VGetUserInfoImport }
     *     
     */
    public CI3496VGetUserInfoImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(CI3496VGetUserInfoImport value) {
        this._import = value;
    }
