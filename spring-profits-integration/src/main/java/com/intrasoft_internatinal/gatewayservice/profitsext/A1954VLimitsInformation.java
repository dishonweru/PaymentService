 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}A1954VLimitsInformationImport" minOccurs="0"/>
...
@XmlRootElement(name = "A1954V_LimitsInformation")
public class A1954VLimitsInformation {

    @XmlElement(name = "import")
    protected A1954VLimitsInformationImport _import;
     ...
     * @return
     *     possible object is
     *     {@link A1954VLimitsInformationImport }
     *     
     */
    public A1954VLimitsInformationImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(A1954VLimitsInformationImport value) {
        this._import = value;
    }
