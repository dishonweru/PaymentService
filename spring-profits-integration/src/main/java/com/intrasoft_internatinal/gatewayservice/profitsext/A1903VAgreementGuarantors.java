 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}AgreementGuarantorsImport" minOccurs="0"/>
...
@XmlRootElement(name = "A1903V_AgreementGuarantors")
public class A1903VAgreementGuarantors {

    @XmlElement(name = "import")
    protected AgreementGuarantorsImport _import;
     ...
     * @return
     *     possible object is
     *     {@link AgreementGuarantorsImport }
     *     
     */
    public AgreementGuarantorsImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(AgreementGuarantorsImport value) {
        this._import = value;
    }
