 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}CustomerAddressMaintenanceImport" minOccurs="0"/>
...
@XmlRootElement(name = "I0106V_CustomerAddressMaintenance")
public class I0106VCustomerAddressMaintenance {

    @XmlElement(name = "import")
    protected CustomerAddressMaintenanceImport _import;
     ...
     * @return
     *     possible object is
     *     {@link CustomerAddressMaintenanceImport }
     *     
     */
    public CustomerAddressMaintenanceImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(CustomerAddressMaintenanceImport value) {
        this._import = value;
    }
