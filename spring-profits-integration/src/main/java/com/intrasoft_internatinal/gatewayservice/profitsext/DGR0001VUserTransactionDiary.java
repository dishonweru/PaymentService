 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}DGR0001V_UserTransactionDiaryImport" minOccurs="0"/>
...
@XmlRootElement(name = "DGR0001V_UserTransactionDiary")
public class DGR0001VUserTransactionDiary {

    @XmlElement(name = "import")
    protected DGR0001VUserTransactionDiaryImport _import;
     ...
     * @return
     *     possible object is
     *     {@link DGR0001VUserTransactionDiaryImport }
     *     
     */
    public DGR0001VUserTransactionDiaryImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(DGR0001VUserTransactionDiaryImport value) {
        this._import = value;
    }
