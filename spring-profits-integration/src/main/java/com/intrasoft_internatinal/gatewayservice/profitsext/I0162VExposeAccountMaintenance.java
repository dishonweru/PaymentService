 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}ExposeAccountMaintenanceImport" minOccurs="0"/>
...
@XmlRootElement(name = "I0162V_ExposeAccountMaintenance")
public class I0162VExposeAccountMaintenance {

    @XmlElement(name = "import")
    protected ExposeAccountMaintenanceImport _import;
     ...
     * @return
     *     possible object is
     *     {@link ExposeAccountMaintenanceImport }
     *     
     */
    public ExposeAccountMaintenanceImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(ExposeAccountMaintenanceImport value) {
        this._import = value;
    }
