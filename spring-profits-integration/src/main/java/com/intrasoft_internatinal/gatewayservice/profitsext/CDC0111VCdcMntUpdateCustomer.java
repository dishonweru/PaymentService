 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}CdcMntUpdateCustomerImport" minOccurs="0"/>
...
@XmlRootElement(name = "CDC0111V_CdcMntUpdateCustomer")
public class CDC0111VCdcMntUpdateCustomer {

    @XmlElement(name = "import")
    protected CdcMntUpdateCustomerImport _import;
     ...
     * @return
     *     possible object is
     *     {@link CdcMntUpdateCustomerImport }
     *     
     */
    public CdcMntUpdateCustomerImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(CdcMntUpdateCustomerImport value) {
        this._import = value;
    }
