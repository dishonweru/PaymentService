 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}CustomerPositionAndDrawdownImport" minOccurs="0"/>
...
@XmlRootElement(name = "I0154V_CustomerPositionAndDrawdown")
public class I0154VCustomerPositionAndDrawdown {

    @XmlElement(name = "import")
    protected CustomerPositionAndDrawdownImport _import;
     ...
     * @return
     *     possible object is
     *     {@link CustomerPositionAndDrawdownImport }
     *     
     */
    public CustomerPositionAndDrawdownImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(CustomerPositionAndDrawdownImport value) {
        this._import = value;
    }
