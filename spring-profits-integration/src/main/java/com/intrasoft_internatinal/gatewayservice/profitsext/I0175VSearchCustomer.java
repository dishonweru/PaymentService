 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}SearchCustomerImport" minOccurs="0"/>
...
@XmlRootElement(name = "I0175V_SearchCustomer")
public class I0175VSearchCustomer {

    @XmlElement(name = "import")
    protected SearchCustomerImport _import;
     ...
     * @return
     *     possible object is
     *     {@link SearchCustomerImport }
     *     
     */
    public SearchCustomerImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(SearchCustomerImport value) {
        this._import = value;
    }
