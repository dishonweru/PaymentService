 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}LettersOfCreditRetrieveImport" minOccurs="0"/>
...
@XmlRootElement(name = "TF3707V_LettersOfCreditMaintenance")
public class TF3707VLettersOfCreditMaintenance {

    @XmlElement(name = "import")
    protected LettersOfCreditRetrieveImport _import;
     ...
     * @return
     *     possible object is
     *     {@link LettersOfCreditRetrieveImport }
     *     
     */
    public LettersOfCreditRetrieveImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(LettersOfCreditRetrieveImport value) {
        this._import = value;
    }
