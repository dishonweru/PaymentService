 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}SendBulkMessageAlertExtImport" minOccurs="0"/>
...
@XmlRootElement(name = "MsgSendBulkMessageAlertExt")
public class MsgSendBulkMessageAlertExt {

    @XmlElement(name = "import")
    protected SendBulkMessageAlertExtImport _import;
     ...
     * @return
     *     possible object is
     *     {@link SendBulkMessageAlertExtImport }
     *     
     */
    public SendBulkMessageAlertExtImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(SendBulkMessageAlertExtImport value) {
        this._import = value;
    }
