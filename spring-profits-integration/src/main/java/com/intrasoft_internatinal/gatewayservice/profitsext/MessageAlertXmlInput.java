 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}MessageAlertXmlInputImport" minOccurs="0"/>
...
@XmlRootElement(name = "MessageAlertXmlInput")
public class MessageAlertXmlInput {

    @XmlElement(name = "import")
    protected MessageAlertXmlInputImport _import;
     ...
     * @return
     *     possible object is
     *     {@link MessageAlertXmlInputImport }
     *     
     */
    public MessageAlertXmlInputImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(MessageAlertXmlInputImport value) {
        this._import = value;
    }
