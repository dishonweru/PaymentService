 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}AgreementBeneficiariesImport" minOccurs="0"/>
...
@XmlRootElement(name = "A1902V_AgreementBeneficiaries")
public class A1902VAgreementBeneficiaries {

    @XmlElement(name = "import")
    protected AgreementBeneficiariesImport _import;
     ...
     * @return
     *     possible object is
     *     {@link AgreementBeneficiariesImport }
     *     
     */
    public AgreementBeneficiariesImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(AgreementBeneficiariesImport value) {
        this._import = value;
    }
