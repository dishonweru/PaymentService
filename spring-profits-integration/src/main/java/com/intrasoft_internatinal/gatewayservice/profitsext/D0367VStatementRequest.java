 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}StatementRequestImport" minOccurs="0"/>
...
@XmlRootElement(name = "D0367V_StatementRequest")
public class D0367VStatementRequest {

    @XmlElement(name = "import")
    protected StatementRequestImport _import;
     ...
     * @return
     *     possible object is
     *     {@link StatementRequestImport }
     *     
     */
    public StatementRequestImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(StatementRequestImport value) {
        this._import = value;
    }
