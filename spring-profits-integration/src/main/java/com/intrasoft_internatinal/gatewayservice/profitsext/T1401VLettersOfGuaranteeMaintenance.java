 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}LettersOfGuaranteeRetrieveImport" minOccurs="0"/>
...
@XmlRootElement(name = "T1401V_LettersOfGuaranteeMaintenance")
public class T1401VLettersOfGuaranteeMaintenance {

    @XmlElement(name = "import")
    protected LettersOfGuaranteeRetrieveImport _import;
     ...
     * @return
     *     possible object is
     *     {@link LettersOfGuaranteeRetrieveImport }
     *     
     */
    public LettersOfGuaranteeRetrieveImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(LettersOfGuaranteeRetrieveImport value) {
        this._import = value;
    }
