 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}CI4100V_GetBanksListImport" minOccurs="0"/>
...
@XmlRootElement(name = "CI4100V_GetBanksList")
public class CI4100VGetBanksList {

    @XmlElement(name = "import")
    protected CI4100VGetBanksListImport _import;
     ...
     * @return
     *     possible object is
     *     {@link CI4100VGetBanksListImport }
     *     
     */
    public CI4100VGetBanksListImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(CI4100VGetBanksListImport value) {
        this._import = value;
    }
