 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}StandbyCollectionPaymentImport" minOccurs="0"/>
...
@XmlRootElement(name = "J2130v_StandbyCollectionPayment")
public class J2130VStandbyCollectionPayment {

    @XmlElement(name = "import")
    protected StandbyCollectionPaymentImport _import;
     ...
     * @return
     *     possible object is
     *     {@link StandbyCollectionPaymentImport }
     *     
     */
    public StandbyCollectionPaymentImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(StandbyCollectionPaymentImport value) {
        this._import = value;
    }
