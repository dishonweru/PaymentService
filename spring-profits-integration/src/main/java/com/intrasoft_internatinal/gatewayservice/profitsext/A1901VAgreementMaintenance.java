 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}AgreementMaintenanceImport" minOccurs="0"/>
...
@XmlRootElement(name = "A1901V_AgreementMaintenance")
public class A1901VAgreementMaintenance {

    @XmlElement(name = "import")
    protected AgreementMaintenanceImport _import;
     ...
     * @return
     *     possible object is
     *     {@link AgreementMaintenanceImport }
     *     
     */
    public AgreementMaintenanceImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(AgreementMaintenanceImport value) {
        this._import = value;
    }
