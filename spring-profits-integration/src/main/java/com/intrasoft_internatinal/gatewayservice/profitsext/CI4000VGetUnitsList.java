 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}CI4000V_GetUnitsListImport" minOccurs="0"/>
...
@XmlRootElement(name = "CI4000V_GetUnitsList")
public class CI4000VGetUnitsList {

    @XmlElement(name = "import")
    protected CI4000VGetUnitsListImport _import;
     ...
     * @return
     *     possible object is
     *     {@link CI4000VGetUnitsListImport }
     *     
     */
    public CI4000VGetUnitsListImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(CI4000VGetUnitsListImport value) {
        this._import = value;
    }
