 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}T1462VlgBeneficiariesImport" minOccurs="0"/>
...
@XmlRootElement(name = "T1462V_LettersOfGuaranteeBeneficiaries")
public class T1462VLettersOfGuaranteeBeneficiaries {

    @XmlElement(name = "import")
    protected T1462VlgBeneficiariesImport _import;
     ...
     * @return
     *     possible object is
     *     {@link T1462VlgBeneficiariesImport }
     *     
     */
    public T1462VlgBeneficiariesImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(T1462VlgBeneficiariesImport value) {
        this._import = value;
    }
