 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}CI3496V_UsersListImport" minOccurs="0"/>
...
@XmlRootElement(name = "CI3496V_UsersList")
public class CI3496VUsersList {

    @XmlElement(name = "import")
    protected CI3496VUsersListImport _import;
     ...
     * @return
     *     possible object is
     *     {@link CI3496VUsersListImport }
     *     
     */
    public CI3496VUsersListImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(CI3496VUsersListImport value) {
        this._import = value;
    }
