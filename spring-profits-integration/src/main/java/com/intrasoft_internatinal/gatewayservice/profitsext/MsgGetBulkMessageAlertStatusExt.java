 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}GetBulkMessageAlertStatusExtImport" minOccurs="0"/>
...
@XmlRootElement(name = "MsgGetBulkMessageAlertStatusExt")
public class MsgGetBulkMessageAlertStatusExt {

    @XmlElement(name = "import")
    protected GetBulkMessageAlertStatusExtImport _import;
     ...
     * @return
     *     possible object is
     *     {@link GetBulkMessageAlertStatusExtImport }
     *     
     */
    public GetBulkMessageAlertStatusExtImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(GetBulkMessageAlertStatusExtImport value) {
        this._import = value;
    }
