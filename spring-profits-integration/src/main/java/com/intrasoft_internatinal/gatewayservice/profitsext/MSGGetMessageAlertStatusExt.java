 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}GetMessageAlertStatusExtImport" minOccurs="0"/>
...
@XmlRootElement(name = "MSG_GetMessageAlertStatusExt")
public class MSGGetMessageAlertStatusExt {

    @XmlElement(name = "import")
    protected GetMessageAlertStatusExtImport _import;
     ...
     * @return
     *     possible object is
     *     {@link GetMessageAlertStatusExtImport }
     *     
     */
    public GetMessageAlertStatusExtImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(GetMessageAlertStatusExtImport value) {
        this._import = value;
    }
