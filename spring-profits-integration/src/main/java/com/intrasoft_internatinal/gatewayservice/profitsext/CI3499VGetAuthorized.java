 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}GetAuthorizedImport" minOccurs="0"/>
...
@XmlRootElement(name = "CI3499V_GetAuthorized")
public class CI3499VGetAuthorized {

    @XmlElement(name = "import")
    protected GetAuthorizedImport _import;
     ...
     * @return
     *     possible object is
     *     {@link GetAuthorizedImport }
     *     
     */
    public GetAuthorizedImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(GetAuthorizedImport value) {
        this._import = value;
    }
