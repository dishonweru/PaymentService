 ...
 *       &lt;sequence>
 *         &lt;element name="import" type="{http://www.intrasoft-internatinal.com/GatewayService/ProfitsExt}SendMessageAlertExtImport" minOccurs="0"/>
...
@XmlRootElement(name = "MSG_SendMessageAlertExt")
public class MSGSendMessageAlertExt {

    @XmlElement(name = "import")
    protected SendMessageAlertExtImport _import;
     ...
     * @return
     *     possible object is
     *     {@link SendMessageAlertExtImport }
     *     
     */
    public SendMessageAlertExtImport getImport() {
        return _import;
    }
     ...
     *     
     */
    public void setImport(SendMessageAlertExtImport value) {
        this._import = value;
    }
